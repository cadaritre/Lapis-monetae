...
fn bench_uint128(c: &mut Criterion) {
    ...
    bench_op(&mut uint128_c, &uint128_one, &uint128_two, |a, b| a / if b.is_zero() { Uint128::from_u64(1) } else { b }, "division");
...
fn bench_uint256(c: &mut Criterion) {
    ...
    bench_op(&mut uint256_c, &uint256_one, &uint256_two, |a, b| a / if b.is_zero() { Uint256::from_u64(1) } else { b }, "division");
...
fn bench_uint3072(c: &mut Criterion) {
    ...
    bench_op(
        ...
        &uint3072_one,
        &uint3072_two,
        |a, b| a / if b.is_zero() { Uint3072::from_u64(1) } else { b },
        "division",
    );
