...
pub const MAINNET_PARAMS: Params = Params {
    dns_seeders: &[
        // Lapis Monetae DNS seeders - red independiente
        "lmt-seeder1.lapismonetae.org",
        "lmt-seeder2.lapismonetae.org",
        "lmt-seeder3.lapismonetae.org",
        "lmt-mainnet.lapismonetae.org",
...
pub const TESTNET_PARAMS: Params = Params {
    dns_seeders: &[
        // Lapis Monetae testnet seeders - red independiente
        "lmt-testnet-seeder1.lapismonetae.org",
        "lmt-testnet-seeder2.lapismonetae.org",
        "lmt-testnet.lapismonetae.org",
    ],
