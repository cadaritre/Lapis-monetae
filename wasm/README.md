...
- **RPC API** — RPC API for the LMT node using WebSockets.
- **Wallet SDK** — Bindings for primitives related to key management and transactions.
- **Wallet API** — API for the Rusty LMT Wallet framework.
...
- `examples/javascript/wallet` - Interfacing with the Rusty LMT Wallet framework.
